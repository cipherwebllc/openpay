...
| `ETHERSCAN_API_KEY` | Server-only key for `/agent` activity. Etherscan V2 uses one key for Polygon too (free tier: 3 calls/s, 100k/day). Unset: history unavailable, with a Polygonscan link in the P2b UI. | optional |
