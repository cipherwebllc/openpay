...
- **テスト** — 765 件 / 42 ファイル (lib mock 0、hook/component は外部 SDK 境界のみ mock)。coverage 98.77 / 96.06 / 90.99 / 98.77。e2e 28 件 (chromium + mobile-safari)
...
本リポジトリの自動テスト (765 件) における mock 利用方針:
...
| Functions | 90.99% |
| Lines | 98.77% |
| Test count | 765 件 (42 ファイル) + e2e 28 件 |
