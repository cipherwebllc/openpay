...
| `ENABLE_CREATOR_STORE` | Server-only creator-store purchase, public purchase-status, and reconciler routes. Default **off**; all three surfaces return 404 while disabled. | optional |
