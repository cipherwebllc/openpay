...
| `NEXT_PUBLIC_ENABLE_USDC_ARC_TIP` | Enables standard USDC tips on Arc, including @handle. Requires `NEXT_PUBLIC_ENABLE_USDC_ARC=1`. No cross-chain; wallet pays gas in USDC. Default **off**. | optional |
