...
- **テスト** — 744 件 / 42 ファイル (lib mock 0、hook/component は外部 SDK 境界のみ mock)。coverage 97.48 / 95.74 / 88.83 / 97.48。e2e 28 件 (chromium + mobile-safari)
...
本リポジトリの自動テスト (744 件) における mock 利用方針:
...
| Functions | 88.83% |
| Lines | 97.48% |
| Test count | 744 件 (42 ファイル) + e2e 28 件 |
