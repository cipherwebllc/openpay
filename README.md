...
| `NEXT_PUBLIC_ENABLE_STORE_DELIVERY_TICKET` | Delivery UI child flag of `NEXT_PUBLIC_ENABLE_CREATOR_STORE`; default **off**. Reserved for the follow-up UI PR; cannot enable server issuance. | optional |
