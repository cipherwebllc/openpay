  ...
  return NextResponse.json(
    {
      ...
      fullFeed: {
        ...
        hint: 'The paid feed returns the full dated history. Pass changedSince=<the nextChangedSince from your previous paid response> to buy only deltas; changes:[] explicitly means no change.',
      },
      notice: full.notice,
