...
const ja: AgentPageContent = {
  ...
  wallet: {
    ...
    fundCta: '入金する',
    changeAddress: '変更',
    emptyLead: '下の「Agent を接続」でセットアップすると、あなたのマシン上にウォレットが作られます。Agent が返すリンクを開くと、ここに残高が表示されます。',
...
const en: AgentPageContent = {
  ...
  wallet: {
    ...
    emptyLead: 'Set up with “Connect your agent” below and a wallet is created on your own machine. Open the link your agent returns and its balance appears here.',
