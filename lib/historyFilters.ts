...
// TODO(review6 F9): 期間/月プリセットと会計CSVの JST 境界を揃える方針を決める。
// 現状、UTC 端末の「9月」には 9/30 15:30Z が含まれ、会計CSVには JST 10/01 と出る。
// フォローアップでは画面表示・期間選択・CSV の対応を決め、非 JST 端末の月境界を検証する。
// ---------------------------------------------------------------------------
