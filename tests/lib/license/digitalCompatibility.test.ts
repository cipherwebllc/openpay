...
const original = {
  // Review 6 B1: IP denial now precedes shared counters; real-Lua regression tests cover the change.
  'QUOTE_RATE_LIMIT': '0baade60485a021d23ba6d27acc8f7ac52ceed14f3bf3b80c914e84fd9f19113',
  ...
  // Upstash cjson alias fix (2026-09-08): latestGrant を別 table として decode。
  'FINALIZE_PURCHASE': '423015d67f326783925405ba001608457f6334702fc72bdcb56ec65dc9f1449a',
